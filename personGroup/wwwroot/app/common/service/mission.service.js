...
var MissionService = (function () {
    function MissionService() {
        ...
        this.missionImageSelect = new Subject_1.Subject();
        // Observable number streams
        this.missionImageSelect$ = this.missionImageSelect.asObservable();
    }
    // Service message commands
    MissionService.prototype.emitMission = function (mission) {
